...
export function PromptInput({
  ...
  const hasSubmittableContent =
    Boolean(currentValue.trim()) || canSubmitWithoutText;
  const canSubmit = hasSubmittableContent && !disabled && !loading;
    ...
    >
      ...
      <div className="mt-1 flex min-h-8 items-center gap-1">
        ...
        <Button
          ...
          aria-label={loading ? "Stop generating" : submitAriaLabel}
